...
const getAllBusinessCustomers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const businessCustomer = yield BusinessCustomerService.getAllBusinessCustomers();
